...
export default function DashboardScreen() {
  ...
  const titleFontSize =
    fontSize === "small" ? 18 : fontSize === "large" ? 28 : 24;
  const sectionFontSize =
    fontSize === "small" ? 15 : fontSize === "large" ? 20 : 17;
  ...
  const tasksByColumn = (col: Column) =>
    MOCK_TASKS.filter((t) => t.column === col);
    ...
    >
      <View style={styles.taskCardHeader}>
        ...
        <Text
          style={[
            styles.taskTitle,
            { color: textColor, fontSize: fontSizeValue },
          ]}
          numberOfLines={2}
        >
          {task.title}
      ...
      {!summaryMode && (
        <Text
          style={[
            ...
            { color: secondaryText, fontSize: fontSizeValue - 2 },
          ]}
          numberOfLines={2}
        >
          {task.description}
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: bg }]}>
      ...
      >
        ...
        >
          <Text
            style={[styles.focusButtonText, { fontSize: fontSizeValue + 2 }]}
          >
            Modo Foco
          </Text>
        </TouchableOpacity>
        ...
        <Text
          style={[
            styles.sectionTitle,
            { color: textColor, fontSize: sectionFontSize },
          ]}
        >
          Ajustes rapidos
        </Text>
